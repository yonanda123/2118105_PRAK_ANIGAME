...
public class CameraFollow : MonoBehaviour
{
    ...
    void TrackPlayer()
    {
        ...
        if (CheckYMargin())
            ...
            targetX = Mathf.Clamp(targetX, minXAndY.x, maxXAndY.x); targetY =
            Mathf.Clamp(targetY, minXAndY.y, maxXAndY.y); transform.position = new Vector3(targetX, targetY, transform.position.z);
    }
}
